...
TEST_F(MemEnvTest, DBTest) {
  ...
  const std::string_view keys[] = {std::string_view("aaa"), std::string_view("bbb"), std::string_view("ccc")};
  const std::string_view vals[] = {std::string_view("foo"), std::string_view("bar"), std::string_view("baz")};
